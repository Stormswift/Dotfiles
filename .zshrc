...
export PATH="~/scripts:/opt/local/bin:/opt/local/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin"
...
alias zrc="vim ~/.zshrc"
alias vrc="vim ~/.vimrc"
alias csd="cd ~/School/2c" # for quick access to current school semester dir
alias c="clear"
